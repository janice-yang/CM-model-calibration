...
%% String Variables
if ~data_istable
LabelInd=strmatch('Label',stringVars,'exact');
...
Ind=strmatch('Whiskers',stringVars,'exact');
if ~isempty(Ind)
...
Ind=strmatch('PointStyle',stringVars,'exact');
if ~isempty(Ind)
...
%% Numeric Variables
Ind=strmatch('Width',stringVars, 'exact');
if ~isempty(Ind)
...
Ind=strmatch('Compression',stringVars,'exact');
if ~isempty(Ind)
...
Ind=strmatch('RangeCut',stringVars,'exact');
if ~isempty(Ind)
...
Ind=strmatch('WhiskersWidthRatio',stringVars,'exact');
if ~isempty(Ind)
...
Ind=strmatch('PointSize',stringVars,'exact');
if ~isempty(Ind)
...
Ind=strmatch('LineWidth',stringVars,'exact');
if ~isempty(Ind)
...
Ind=strmatch('MarkerEdgeColor',stringVars,'exact');
EdgeIsArray=false;
if ~isempty(Ind)
...
Ind=strmatch('MarkerFaceColor',stringVars,'exact');
...
Ind=strmatch('MeanColor',stringVars,'exact');
...
Ind=strmatch('SEMColor',stringVars,'exact');
...
Ind=strmatch('StdColor',stringVars,'exact');
...
% save univar range_val RangeCut yValues xValues
