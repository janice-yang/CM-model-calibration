function [deriv, currents] = f_Paci13_v(t, statevar, geometry, conductances, parameters)
...
tauf2 = ((600*exp(-(((statevar(15)*1000+25)^2)/170))) + (31/(1+exp((-statevar(15)*1000+25)/10))) +  (16/(1+exp((statevar(15)*1000+30)/10))))/1000 ;
...
Iup = G_SERCA * Vmaxup/(1.0+Kup^2.0/statevar(17)^2.0);
